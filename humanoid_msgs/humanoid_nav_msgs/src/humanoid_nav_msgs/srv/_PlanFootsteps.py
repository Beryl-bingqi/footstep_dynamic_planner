...
class PlanFootstepsResponse(genpy.Message):
  _md5sum = "32378b94294740bda5dde3155bccf722"
...
float64 theta
"""
  __slots__ = ['result','footsteps','costs']
  _slot_types = ['bool','humanoid_nav_msgs/StepTarget[]','float64']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_d.pack(self.costs))
    except struct.error as se: self._check_types(se)
    except TypeError as te: self._check_types(te)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.costs,) = _struct_d.unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class PlanFootsteps(object):
  ...
  _md5sum = 'd183523742b62dfc274a075b0040ea3f'
