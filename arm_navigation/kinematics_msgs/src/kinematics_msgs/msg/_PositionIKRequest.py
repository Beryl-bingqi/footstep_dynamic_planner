"""autogenerated by genpy from kinematics_msgs/PositionIKRequest.msg. Do not edit."""
import sys
...
class PositionIKRequest(genpy.Message):
  _md5sum = "737bb756c6253bdd460b1383d0b12dac"
  _type = "kinematics_msgs/PositionIKRequest"
...
"""
  __slots__ = ['ik_link_name','pose_stamped','ik_seed_state','robot_state']
  _slot_types = ['string','geometry_msgs/PoseStamped','arm_navigation_msgs/RobotState','arm_navigation_msgs/RobotState']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       ik_link_name,pose_stamped,ik_seed_state,robot_state
    ...
    if args or kwds:
      ...
      if self.ik_seed_state is None:
        self.ik_seed_state = arm_navigation_msgs.msg.RobotState()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.ik_seed_state.joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      for val1 in self.ik_seed_state.joint_state.name:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.ik_seed_state.joint_state.position)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.ik_seed_state.joint_state.position))
      length = len(self.ik_seed_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.ik_seed_state.joint_state.velocity))
      length = len(self.ik_seed_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.ik_seed_state.joint_state.effort))
      _x = self
      buff.write(_struct_2I.pack(_x.ik_seed_state.multi_dof_joint_state.stamp.secs, _x.ik_seed_state.multi_dof_joint_state.stamp.nsecs))
      length = len(self.ik_seed_state.multi_dof_joint_state.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_seed_state.multi_dof_joint_state.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.ik_seed_state.multi_dof_joint_state.frame_ids)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_seed_state.multi_dof_joint_state.frame_ids:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.ik_seed_state.multi_dof_joint_state.child_frame_ids)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_seed_state.multi_dof_joint_state.child_frame_ids:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.ik_seed_state.multi_dof_joint_state.poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_seed_state.multi_dof_joint_state.poses:
        _v1 = val1.position
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.ik_seed_state.joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.ik_seed_state.joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_seed_state.joint_state.name = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.ik_seed_state.joint_state.name.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ik_seed_state.joint_state.position = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ik_seed_state.joint_state.velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ik_seed_state.joint_state.effort = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 8
      (_x.ik_seed_state.multi_dof_joint_state.stamp.secs, _x.ik_seed_state.multi_dof_joint_state.stamp.nsecs,) = _struct_2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_seed_state.multi_dof_joint_state.joint_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.ik_seed_state.multi_dof_joint_state.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_seed_state.multi_dof_joint_state.frame_ids = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.ik_seed_state.multi_dof_joint_state.frame_ids.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_seed_state.multi_dof_joint_state.child_frame_ids = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.ik_seed_state.multi_dof_joint_state.child_frame_ids.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_seed_state.multi_dof_joint_state.poses = []
      for i in range(0, length):
        ...
        self.ik_seed_state.multi_dof_joint_state.poses.append(val1)
      _x = self
      start = end
      end += 12
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.ik_seed_state.joint_state.position.tostring())
      length = len(self.ik_seed_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.ik_seed_state.joint_state.velocity.tostring())
      length = len(self.ik_seed_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.ik_seed_state.joint_state.effort.tostring())
      _x = self
      buff.write(_struct_2I.pack(_x.ik_seed_state.multi_dof_joint_state.stamp.secs, _x.ik_seed_state.multi_dof_joint_state.stamp.nsecs))
      length = len(self.ik_seed_state.multi_dof_joint_state.joint_names)
      buff.write(_struct_I.pack(length))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.ik_seed_state.joint_state.position = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ik_seed_state.joint_state.velocity = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ik_seed_state.joint_state.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 8
      (_x.ik_seed_state.multi_dof_joint_state.stamp.secs, _x.ik_seed_state.multi_dof_joint_state.stamp.nsecs,) = _struct_2I.unpack(str[start:end])
