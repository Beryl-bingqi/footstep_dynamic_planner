"""autogenerated by genpy from spline_smoother/LSPBTrajectoryMsg.msg. Do not edit."""
import sys
...
class LSPBTrajectoryMsg(genpy.Message):
...
"""
  ...
  _slot_types = ['std_msgs/Header','string[]','spline_smoother/LSPBTrajectorySegmentMsg[]']
