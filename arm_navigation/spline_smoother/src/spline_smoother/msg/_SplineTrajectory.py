"""autogenerated by genpy from spline_smoother/SplineTrajectory.msg. Do not edit."""
import sys
...
class SplineTrajectory(genpy.Message):
  _md5sum = "45d783dc5c58ac7ae093c93ba1b8d451"
  _type = "spline_smoother/SplineTrajectory"
...
"""
  ...
  _slot_types = ['std_msgs/Header','string[]','spline_smoother/SplineTrajectorySegment[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SplineTrajectory, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.segments = []
      for i in range(0, length):
        val1 = spline_smoother.msg.SplineTrajectorySegment()
        _v2 = val1.duration
        _x = _v2
        start = end
        end += 8
        ...
        val1.joints = []
        for i in range(0, length):
          val2 = spline_smoother.msg.SplineCoefficients()
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          pattern = '<%sd'%length
