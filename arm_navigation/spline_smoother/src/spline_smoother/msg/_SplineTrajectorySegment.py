"""autogenerated by genpy from spline_smoother/SplineTrajectorySegment.msg. Do not edit."""
import sys
...
class SplineTrajectorySegment(genpy.Message):
  _md5sum = "1c95257e91547459aede67dd02a209d6"
  _type = "spline_smoother/SplineTrajectorySegment"
...
"""
  ...
  _slot_types = ['duration','spline_smoother/SplineCoefficients[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SplineTrajectorySegment, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = spline_smoother.msg.SplineCoefficients()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
