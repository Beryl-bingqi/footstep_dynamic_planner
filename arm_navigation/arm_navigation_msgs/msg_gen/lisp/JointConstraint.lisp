...
(cl:defmethod cl:initialize-instance :after ((m <JointConstraint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointConstraint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_navigation_msgs-msg:<JointConstraint> is deprecated: use arm_navigation_msgs-msg:JointConstraint instead.")))
...
(cl:defmethod tolerance_above-val ((m <JointConstraint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:tolerance_above-val is deprecated.  Use arm_navigation_msgs-msg:tolerance_above instead.")
  (tolerance_above m))

(cl:ensure-generic-function 'tolerance_below-val :lambda-list '(m))
(cl:defmethod tolerance_below-val ((m <JointConstraint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:tolerance_below-val is deprecated.  Use arm_navigation_msgs-msg:tolerance_below instead.")
  (tolerance_below m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<JointConstraint>)))
  ...
  (cl:format cl:nil "# Constrain the position of a joint to be within a certain bound~%string joint_name~%~%# the bound to be achieved is [position - tolerance_below, position + tolerance_above]~%float64 position~%float64 tolerance_above~%float64 tolerance_below~%~%# A weighting factor for this constraint~%float64 weight~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'JointConstraint)))
  "Returns full string definition for message of type 'JointConstraint"
  (cl:format cl:nil "# Constrain the position of a joint to be within a certain bound~%string joint_name~%~%# the bound to be achieved is [position - tolerance_below, position + tolerance_above]~%float64 position~%float64 tolerance_above~%float64 tolerance_below~%~%# A weighting factor for this constraint~%float64 weight~%~%"))
