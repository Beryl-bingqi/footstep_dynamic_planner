...
(cl:defmethod cl:initialize-instance :after ((m <AllowedCollisionEntry>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AllowedCollisionEntry)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_navigation_msgs-msg:<AllowedCollisionEntry> is deprecated: use arm_navigation_msgs-msg:AllowedCollisionEntry instead.")))

(cl:ensure-generic-function 'enabled-val :lambda-list '(m))
(cl:defmethod enabled-val ((m <AllowedCollisionEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:enabled-val is deprecated.  Use arm_navigation_msgs-msg:enabled instead.")
  (enabled m))
