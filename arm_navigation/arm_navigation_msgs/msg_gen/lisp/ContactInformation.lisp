...
(cl:defclass <ContactInformation> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (contact_body_1
    ...
    :initform "")
   (attached_body_1
    :reader attached_body_1
    :initarg :attached_body_1
    :type cl:string
    :initform "")
   (body_type_1
    :reader body_type_1
   ...
   (contact_body_2
    ...
    :initform "")
   (attached_body_2
    :reader attached_body_2
    :initarg :attached_body_2
    :type cl:string
    :initform "")
   (body_type_2
    :reader body_type_2
...
(cl:defmethod cl:initialize-instance :after ((m <ContactInformation>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ContactInformation)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_navigation_msgs-msg:<ContactInformation> is deprecated: use arm_navigation_msgs-msg:ContactInformation instead.")))
...
(cl:defmethod normal-val ((m <ContactInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:normal-val is deprecated.  Use arm_navigation_msgs-msg:normal instead.")
  (normal m))

(cl:ensure-generic-function 'depth-val :lambda-list '(m))
(cl:defmethod depth-val ((m <ContactInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:depth-val is deprecated.  Use arm_navigation_msgs-msg:depth instead.")
  (depth m))

(cl:ensure-generic-function 'contact_body_1-val :lambda-list '(m))
(cl:defmethod contact_body_1-val ((m <ContactInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:contact_body_1-val is deprecated.  Use arm_navigation_msgs-msg:contact_body_1 instead.")
  (contact_body_1 m))

(cl:ensure-generic-function 'attached_body_1-val :lambda-list '(m))
(cl:defmethod attached_body_1-val ((m <ContactInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:attached_body_1-val is deprecated.  Use arm_navigation_msgs-msg:attached_body_1 instead.")
  (attached_body_1 m))

(cl:ensure-generic-function 'body_type_1-val :lambda-list '(m))
(cl:defmethod body_type_1-val ((m <ContactInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:body_type_1-val is deprecated.  Use arm_navigation_msgs-msg:body_type_1 instead.")
  (body_type_1 m))

(cl:ensure-generic-function 'contact_body_2-val :lambda-list '(m))
(cl:defmethod contact_body_2-val ((m <ContactInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:contact_body_2-val is deprecated.  Use arm_navigation_msgs-msg:contact_body_2 instead.")
  (contact_body_2 m))

(cl:ensure-generic-function 'attached_body_2-val :lambda-list '(m))
(cl:defmethod attached_body_2-val ((m <ContactInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:attached_body_2-val is deprecated.  Use arm_navigation_msgs-msg:attached_body_2 instead.")
  (attached_body_2 m))

(cl:ensure-generic-function 'body_type_2-val :lambda-list '(m))
(cl:defmethod body_type_2-val ((m <ContactInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:body_type_2-val is deprecated.  Use arm_navigation_msgs-msg:body_type_2 instead.")
  (body_type_2 m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ContactInformation>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'attached_body_1))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'attached_body_1))
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'attached_body_2))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'attached_body_2))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ContactInformation>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'normal) istream)
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'attached_body_1) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'attached_body_1) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'attached_body_2) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'attached_body_2) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ContactInformation>)))
  ...
  "85f341c0166ad4e68b4421391bbd2e15")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ContactInformation)))
  "Returns md5sum for a message object of type 'ContactInformation"
  "85f341c0166ad4e68b4421391bbd2e15")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ContactInformation>))
  (cl:+ 0
     ...
     4 (cl:length (cl:slot-value msg 'attached_body_1))
     4
     4 (cl:length (cl:slot-value msg 'contact_body_2))
     4 (cl:length (cl:slot-value msg 'attached_body_2))
     4
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ContactInformation>))
  ...
  (cl:list 'ContactInformation
    ...
    (cl:cons ':attached_body_1 (attached_body_1 msg))
    (cl:cons ':body_type_1 (body_type_1 msg))
    (cl:cons ':contact_body_2 (contact_body_2 msg))
    (cl:cons ':attached_body_2 (attached_body_2 msg))
