...
(cl:defclass <CollisionObject> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (operation
    :reader operation
    :initarg :operation
    :type arm_navigation_msgs-msg:CollisionObjectOperation
    :initform (cl:make-instance 'arm_navigation_msgs-msg:CollisionObjectOperation))
   (shapes
    :reader shapes
    :initarg :shapes
    :type (cl:vector arm_navigation_msgs-msg:Shape)
   :initform (cl:make-array 0 :element-type 'arm_navigation_msgs-msg:Shape :initial-element (cl:make-instance 'arm_navigation_msgs-msg:Shape)))
   (poses
    :reader poses
    :initarg :poses
...
(cl:defmethod cl:initialize-instance :after ((m <CollisionObject>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CollisionObject)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_navigation_msgs-msg:<CollisionObject> is deprecated: use arm_navigation_msgs-msg:CollisionObject instead.")))
...
(cl:defmethod id-val ((m <CollisionObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:id-val is deprecated.  Use arm_navigation_msgs-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'padding-val :lambda-list '(m))
(cl:defmethod padding-val ((m <CollisionObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:padding-val is deprecated.  Use arm_navigation_msgs-msg:padding instead.")
  (padding m))
...
(cl:defmethod shapes-val ((m <CollisionObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:shapes-val is deprecated.  Use arm_navigation_msgs-msg:shapes instead.")
  (shapes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CollisionObject>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'shapes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'arm_navigation_msgs-msg:Shape))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CollisionObject>)))
  ...
  "7b972910c23ece1b873b3de0cf92ba97")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CollisionObject)))
  "Returns md5sum for a message object of type 'CollisionObject"
  "7b972910c23ece1b873b3de0cf92ba97")
