...
(cl:defclass <CollisionMap> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (boxes
    :reader boxes
    :initarg :boxes
    :type (cl:vector arm_navigation_msgs-msg:OrientedBoundingBox)
   :initform (cl:make-array 0 :element-type 'arm_navigation_msgs-msg:OrientedBoundingBox :initial-element (cl:make-instance 'arm_navigation_msgs-msg:OrientedBoundingBox))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CollisionMap>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CollisionMap)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_navigation_msgs-msg:<CollisionMap> is deprecated: use arm_navigation_msgs-msg:CollisionMap instead.")))
...
(cl:defmethod boxes-val ((m <CollisionMap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_navigation_msgs-msg:boxes-val is deprecated.  Use arm_navigation_msgs-msg:boxes instead.")
  (boxes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CollisionMap>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'arm_navigation_msgs-msg:OrientedBoundingBox))
