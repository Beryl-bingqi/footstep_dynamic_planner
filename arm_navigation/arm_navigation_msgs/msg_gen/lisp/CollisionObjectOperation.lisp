...
(cl:defmethod cl:initialize-instance :after ((m <CollisionObjectOperation>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CollisionObjectOperation)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_navigation_msgs-msg:<CollisionObjectOperation> is deprecated: use arm_navigation_msgs-msg:CollisionObjectOperation instead.")))
